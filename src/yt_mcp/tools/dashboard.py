...
def register(mcp, resolver: InstanceResolver):
    ...
    async def get_top_active_issues(
        ...
        Args:
            project: Project short name (e.g., 'AP', 'DO', 'PROJ')
    ...
    async def get_issues_digest(
        ...
        Args:
            query: YouTrack search query (e.g., 'project: DO State: {In Progress}', 'issue id: PROJ-1828')
    ...
    async def get_at_risk_issues(
        ...
        Args:
            project: Project short name (e.g., 'DO', 'AP', 'PROJ')
