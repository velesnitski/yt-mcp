...
def register(mcp, client: YouTrackClient):
    ...
    async def get_issue_links(issue_id: str) -> str:
        ...
        Args:
            issue_id: Issue ID (e.g., 'PROJ-1828')
        """
        data = await client.get(
            f"/api/issues/{issue_id}",
            params={
    ...
    async def add_issue_link(
        ...
        Args:
            issue_id: Source issue ID (e.g., 'PROJ-1828')
            target_id: Target issue ID to link to (e.g., 'PROJ-1234')
    ...
    async def remove_issue_link(
        ...
        Args:
            issue_id: Source issue ID (e.g., 'PROJ-1828')
            target_id: Target issue ID to unlink (e.g., 'PROJ-1234')
