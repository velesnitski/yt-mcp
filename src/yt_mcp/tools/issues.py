...
def register(mcp, resolver: InstanceResolver):
    ...
    async def get_issue_links(issue_id: str, instance: str = "") -> str:
        ...
        Args:
            issue_id: Issue ID (e.g., 'PROJ-1828') or YouTrack issue URL
            instance: YouTrack instance name (optional, for multi-instance setups)
        """
        client = resolver.resolve(instance, issue_id)
        issue_id = parse_issue_id(issue_id)
    ...
    async def add_issue_link(
        ...
        Args:
            issue_id: Source issue ID (e.g., 'PROJ-1828') or YouTrack issue URL
            target_id: Target issue ID to link to (e.g., 'PROJ-1234') or YouTrack issue URL
    ...
    async def remove_issue_link(
        ...
        Args:
            issue_id: Source issue ID (e.g., 'PROJ-1828') or YouTrack issue URL
            target_id: Target issue ID to unlink (e.g., 'PROJ-1234') or YouTrack issue URL
