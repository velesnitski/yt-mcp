...
> **Note:** since v1.18.0, release notes live on the
> [GitHub Releases page](https://github.com/velesnitski/yt-mcp/releases)
> (auto-generated per release) and per-decision detail in
> [`docs/adr/`](docs/adr/). Entries below cover 1.0.0–1.7.0.
