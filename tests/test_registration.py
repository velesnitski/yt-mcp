...
class TestToolRegistration:
    def test_all_tools_registered(self):
        ...
        assert len(tools) == 82, f"Expected 82 tools, got {len(tools)}: {sorted(tools)}"
    ...
    def test_expected_tools_present(self):
        ...
        expected = {
            ...
            "list_attachments", "get_attachment_url", "add_attachment", "count_issues",
    ...
    def test_write_tools_set_complete(self):
        ...
        expected_write = {
            "create_issue", "create_issue_from_template", "update_issue", "transition_issue",
...
class TestCoreToolset:
    ...
    def test_full_unchanged(self):
        assert len(self._register(toolset="full")) == 82
